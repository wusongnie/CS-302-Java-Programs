...
public class TestSticks {
	 ...
	 * 1. Test if basicChooseAction returns 0 when sticks remaining is 0.
	 * 2. Test if basicChooseAction returns 0 when sticks remaining is a negative value.
	 * 3. Test if basicChooseAction returns 1 when sticks remaining is 2.
	 * 4. Test if basicChooseAction returns a value between Config.MIN_ACTION and Config.MAX_ACTION
	 *    when there are 10 (more than Config.MAX_ACTION) sticks remaining.
	 * 5. Test if basicChooseAction returns 1 for 329 times,returns 2
	 *    for 339 times, and returns 3 for 332 times when the seed is 123.
	 */
	 ...
	 * 1. Test if aiChooseAction returns 0 when sticks remaining is 0 or the action 
	 *    ranking is empty.
	 * 2. Test if aiChooseAction returns 0 when sticks remaining is a negative
	 *    value.
	 * 3. Test if aiChooseAction returns a value between Config.MAX_ACTION and Config.MIN_ACTION
	 *    when sticks remaining is more than Config.MAX_ACTION.
	 * 4. Test if aiChooseAction returns the intended value whose ranking
	 *    is set to be largest.
	 * 5. Test if basicChooseAction returns 1 for 1037 times,returns 2
	 *    for 5819 times, and returns 3 for 3144 times when the seed is 123 
	 *    and the action ranking is {1,6,3}.
	 *    
	 */
	 ...
	 * 1. Test if initializeActionRanking returns without an error
	 *    when action ranking passed to the function is null.
	 * 2. Test if all elements in action ranking are set to 1. 
	 * 3. Further test if all elements in action ranking are set to 1. 
	 */
	 ...
	 * 1. Test if the expected string is returned.
	 * 2. Test if the string ends with a new line.
	 */
	 ...
	 * 1. Test if every element in actionRanking is correctly decreased by 1.
	 */
	 ...
	 * 1. Test if every element in actionRanking is correctly increased by 1.
	 */
	 ...
	 * 1. Test if the length of strategyTable equals to the startSticks passed in.
	 * 2. Test if the width of strategyTable equals to the number of possible actions.
	 * 3. Test if every element of strategyTable is 1 by testing the value of strategyTable[0][0].
	 */
	 ...
	 * 1. Test if the string(stategyTable output) is the expected one.
	 */
	 ...
	 * 1. Create two sets of values which are 0s. Then call the method
	 *    to see if they are correctly increased by 1.
	 * 
	 */
	 ...
	 * 1. Create two sets of values which are 2s. Then call the method
	 *    to see if they are correctly decreased by 1.
	 */
	 ...
	 * 1. Test if any possible return of aiVsAi is 1 or 2.
	 * 2. Test if aiVsAi returns the expects winner when sticks remaining is one or two
     *	  and the last to pick up the stick is the loser.
     * 3. Test if every element in player 1's action history is either 0 or 
     *    between Config.MIN_ACTION and Config.MAX_ACTION.
     * 4. Test if every element in player 2's action history is either 0 or 
     *    between Config.MIN_ACTION and Config.MAX_ACTION.
	 * 5.
	 */
	 ...
	 * 1. Test if the trainAi returns null when sticks on the table is less than
	 * 	  Config.MIN_STICKS or the strategy table is null.
	 * 2. Test if the length of the strategy table equals to startSticks.
	 * 3. Test if the width of the strategy table equals to NUM_ACTIONS.
	 * 
	 * 
	 */
